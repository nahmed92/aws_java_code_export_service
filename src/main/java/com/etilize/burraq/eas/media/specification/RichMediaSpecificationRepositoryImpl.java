...
/**
 * It is an implementation of {@link RichMediaSpecificationCustomRepository}
 *
 * @author Umar Zubair
 * @since 1.0
 */
public class RichMediaSpecificationRepositoryImpl
        implements RichMediaSpecificationCustomRepository {
     ...
     */
    @Autowired
    public RichMediaSpecificationRepositoryImpl(final AmazonDynamoDB amazonDynamoDB) {
