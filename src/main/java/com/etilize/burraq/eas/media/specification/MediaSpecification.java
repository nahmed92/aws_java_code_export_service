 ...
 * @since 1.0
 */
public abstract class MediaSpecification extends AbstractDynamoEntity {
    ...
    public final boolean equals(final Object obj) {
        ...
        if (!(obj instanceof MediaSpecification)) {
            return false;
        }
        final MediaSpecification specs = (MediaSpecification) obj;
