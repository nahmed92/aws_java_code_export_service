 ...
 * @since 1.0
 */
public abstract class ProductMediaSpecification extends AbstractDynamoEntity {

    private String productId;

    private String localeId;

    private Map<String, ProductMediaAttributeValue> attributes;

    @DateTimeFormat(iso = ISO.DATE_TIME)
    private Date lastUpdateDate;

    public ProductMediaSpecification() {
     ...
     */
    public Map<String, ProductMediaAttributeValue> getAttributes() {
        return attributes;
    }
     ...
     */
    public void setAttributes(final Map<String, ProductMediaAttributeValue> attributes) {
    ...
    public final boolean equals(final Object obj) {
        ...
        if (!(obj instanceof ProductMediaSpecification)) {
            return false;
        }
        final ProductMediaSpecification specs = (ProductMediaSpecification) obj;
