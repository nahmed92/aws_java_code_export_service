...
import static com.etilize.burraq.eas.barcode.ProductBarcode.*;
...
public class ProductBarcode {
    ...
    public static final String TABLE_NAME = "product-barcodes";

    @Id
    private ProductBarcodeKey barcodeKey;
    ...
    public void setId(final String id) {
        if (barcodeKey == null) {
            barcodeKey = new ProductBarcodeKey();
        }
        barcodeKey.setId(id);
    }
    ...
    public final boolean equals(final Object obj) {
        ...
        final ProductBarcode customerCode = (ProductBarcode) obj;
