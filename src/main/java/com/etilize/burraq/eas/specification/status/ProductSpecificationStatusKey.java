 ...
 * @since 1.0
 */
public class ProductSpecificationStatusKey {
    ...
    public final boolean equals(final Object obj) {
        ...
        if (!(obj instanceof ProductSpecificationStatusKey)) {
            return false;
        }
        final ProductSpecificationStatusKey specificationStatusId = (ProductSpecificationStatusKey) obj;
