...
/**
 * It defines common services for {@link ProductDetailedSpecificationRepository} & {@link ProductBasicSpecificationRepository}
 *
 * @author Umar Zubair
 * @since 1.0
 */
public interface ProductSpecificationCustomRepository {
     ...
     */
    void saveAttributes(UpdateProductSpecificationRequest request);
     ...
     */
    Optional<ProductSpecification> findOne(String id);
