 ...
 * @since 1.0
 */
public class SpecificationStatusKey {
    ...
    public final boolean equals(final Object obj) {
        ...
        if (!(obj instanceof SpecificationStatusKey)) {
            return false;
        }
        final SpecificationStatusKey specificationStatusId = (SpecificationStatusKey) obj;
