...
import static com.etilize.burraq.eas.specification.status.ProductSpecificationStatus.*;
...
public class ProductSpecificationStatus extends AbstractDynamoEntity {
    ...
    public ProductSpecificationStatus() {
    ...
    public final boolean equals(final Object obj) {
        ...
        if (!(obj instanceof ProductSpecificationStatus)) {
            return false;
        }
        final ProductSpecificationStatus status = (ProductSpecificationStatus) obj;
