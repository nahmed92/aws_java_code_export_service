...
import static com.etilize.burraq.eas.category.structures.RichMediaCategoryStructure.*;
...
/**
 * This class represents POJO for rich media category structure.
 *
 * @author Umar Zubair
 * @since 1.0
 */
@DynamoDBTable(tableName = TABLE_NAME)
public class RichMediaCategoryStructure extends CategoryStructure {

    public static final String TABLE_NAME = "rich_media_category_structures";
    ...
    public RichMediaCategoryStructure() {
