...
import static com.etilize.burraq.eas.category.structures.BasicMediaCategoryStructure.*;
...
/**
 * This class represents POJO for basic media category structure.
 *
 * @author Umar Zubair
 * @since 1.0
 */
@DynamoDBTable(tableName = TABLE_NAME)
public class BasicMediaCategoryStructure extends CategoryStructure {

    public static final String TABLE_NAME = "basic_media_category_structures";

    @Id
    private CategoryStructureKey categoryKey;
    ...
    public BasicMediaCategoryStructure() {
    ...
    public void setCategoryId(final String categoryId) {
        if (categoryKey == null) {
            categoryKey = new CategoryStructureKey();
        }
