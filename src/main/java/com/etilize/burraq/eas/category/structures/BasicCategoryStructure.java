...
import static com.etilize.burraq.eas.category.structures.BasicCategoryStructure.*;
...
/**
 * This class represents POJO for basic category structure.
 *
 * @author Umar Zubair
 * @since 1.0
 */
@DynamoDBTable(tableName = TABLE_NAME)
public class BasicCategoryStructure extends CategoryStructure {

    public static final String TABLE_NAME = "basic_category_structures";
