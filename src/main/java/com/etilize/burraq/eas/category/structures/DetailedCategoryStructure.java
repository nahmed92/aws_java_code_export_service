...
import static com.etilize.burraq.eas.category.structures.DetailedCategoryStructure.*;
...
/**
 * This class represents POJO for detailed category structure.
 *
 * @author Umar Zubair
 * @since 1.0
 */
@DynamoDBTable(tableName = TABLE_NAME)
public class DetailedCategoryStructure extends CategoryStructure {

    public static final String TABLE_NAME = "detailed_category_structures";
    ...
    public DetailedCategoryStructure() {
