...
import static com.etilize.burraq.eas.customer.code.ProductCustomerCode.*;
...
public class ProductCustomerCode {

    public static final String TABLE_NAME = "product-customer-codes";

    @Id
    private ProductCustomerCodeKey customerCodeKey;
    ...
    public void setId(final String id) {
        if (customerCodeKey == null) {
            customerCodeKey = new ProductCustomerCodeKey();
        }
    ...
    public final boolean equals(final Object obj) {
        ...
        if (!(obj instanceof ProductCustomerCode)) {
            return false;
        }
        final ProductCustomerCode customerCode = (ProductCustomerCode) obj;
