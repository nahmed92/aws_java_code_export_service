...
/**
 * It implements {@link ProductCustomerCodeService}
 *
 * @author Umar Zubair
 * @since 1.0
 */
@Service
public class ProductCustomerCodeServiceImpl implements ProductCustomerCodeService {
    ...
    private final ProductCustomerCodeRepository repository;
     ...
     *
     * @param repository {@link ProductCustomerCodeRepository}
     * @param localeService {@link LocaleService}
     */
    @Autowired
    public ProductCustomerCodeServiceImpl(final ProductCustomerCodeRepository repository,
