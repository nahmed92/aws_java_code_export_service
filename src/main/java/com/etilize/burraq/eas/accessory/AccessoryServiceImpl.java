...
public class AccessoryServiceImpl implements AccessoryService {
    ...
    private static final String MARKETID_IS_REQUIRED = "marketId is required";

    private static final String ACCESSORYPRODUCTID_IS_REQUIRED = "accessoryProductId is required";
    ...
    public void save(final String productId, final String marketId,
        ...
        Assert.hasText(marketId, MARKETID_IS_REQUIRED);
        Assert.hasText(accessoryProductId, ACCESSORYPRODUCTID_IS_REQUIRED);
