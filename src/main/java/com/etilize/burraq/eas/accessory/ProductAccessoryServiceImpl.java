...
/**
 * It implements {@link ProductAccessoryService}
 *
 * @author Umar Zubair
 * @since 1.0
 */
...
public class ProductAccessoryServiceImpl implements ProductAccessoryService {
    ...
    private final ProductAccessoryRepository repository;
     ...
     *
     * @param repository {@link ProductAccessoryRepository}
     * @param localeService {@link LocaleService}
     */
    @Autowired
    public ProductAccessoryServiceImpl(final ProductAccessoryRepository repository,
