...
/**
 * This class represents POJO test cases for {@link Attribute}.
 *
 * @author Umar Zubair
 */
public class AttributePojoTest {
    ...
    public void validateAttributePojo() {
        ...
        validator = ValidatorBuilder.create() //
                ...
                .build();
        validator.validate(PojoClassFactory.getPojoClass(Attribute.class));
    }
    ...
    public void shouldHaveToString() throws ParseException {
        final Attribute attribute = new Attribute("speed", "desc", "industryId123",
                "help text", Type.NUMBER);
