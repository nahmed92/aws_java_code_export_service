...
import com.etilize.burraq.eas.category.specification.CategorySpecificationServiceImpl;
...
/**
 * This class implements repository test cases for {@link CategorySpecificationService}.
 *
 * @author Umar Zubair
 * @since 1.0
 */
...
public class CategorySpecificationIntegrationTest extends AbstractIntegrationTest {
    ...
    @Autowired
    private CategoryBasicSpecificationRepository basicCategoryStructureRepository;

    @Autowired
    private CategoryDetailedSpecificationRepository detailedCategoryStructureRepository;

    @Autowired
    private CategoryBasicMediaSpecificationRepository basicMediaCategoryStructureRepository;
