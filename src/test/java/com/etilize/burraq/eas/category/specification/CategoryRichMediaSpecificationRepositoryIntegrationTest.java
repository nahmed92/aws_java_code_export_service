...
import com.etilize.burraq.eas.category.specification.CategoryRichMediaSpecification;
...
/**
 * This class implements repository test cases for {@link CategoryRichMediaSpecificationRepository}.
 *
 * @author Umar Zubair
 * @since 1.0
 */
@UsingDataSet(locations = "/datasets/rich_media_category_structures/rich_media_category_structures.bson", loadStrategy = LoadStrategyEnum.CLEAN_INSERT)
@CustomComparisonStrategy(comparisonStrategy = DynamoFlexibleComparisonStrategy.class)
public class CategoryRichMediaSpecificationRepositoryIntegrationTest
    ...
    @Test
    public void shouldFindRichMediaCategoryStructuresByMultipleIds() {
        ...
        final Iterator<CategoryRichMediaSpecification> categories = repository.findAllById(
                Lists.newArrayList(key1, key2)).iterator();
        assertThat(categories.hasNext(), is(true));
        CategoryRichMediaSpecification category = categories.next();
    ...
    @Test
    public void shouldFindRichMediaCategoryStructuresById() {
    ...
    @Test
    @ShouldMatchDataSet(location = "/datasets/rich_media_category_structures/rich_media_category_structures_after_create.bson")
    public void shouldCreateNewRichMediaCategoryStructure() {
        final CategoryRichMediaSpecification category = new CategoryRichMediaSpecification();
    ...
    @Test
    @ShouldMatchDataSet(location = "/datasets/rich_media_category_structures/rich_media_category_structures_after_update.bson")
    ...
    @Test
    @ShouldMatchDataSet(location = "/datasets/rich_media_category_structures/rich_media_category_structures_after_delete.bson")
    public void shouldDeleteRichMediaCategoryStructureById() {
        final CategorySpecificationKey key = new CategorySpecificationKey();
        key.setCategoryId("categoryId123");
        key.setLocaleId("en_CA");
