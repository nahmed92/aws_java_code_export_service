...
/**
 * This class implements repository test cases for {@link BasicCategoryStructureRepository}.
 *
 * @author Umar Zubair
 * @since 1.0
 */
...
public class BasicCategoryStructureRepositoryIntegrationTest
        extends AbstractIntegrationTest {

    @Autowired
    private BasicCategoryStructureRepository repository;
    ...
    public void shouldFindBasicCategoryStructuresByMultipleIds() {
        ...
        final Iterator<BasicCategoryStructure> categories = repository.findAllById(
                Lists.newArrayList(key1, key2)).iterator();
        assertThat(categories.hasNext(), is(true));
        BasicCategoryStructure category = categories.next();
    ...
    public void shouldFindBasicCategoryStructuresById() {
        ...
        final Optional<BasicCategoryStructure> category = repository.findById(key);
    ...
    public void shouldCreateNewBasicCategoryStructure() {
        final BasicCategoryStructure category = new BasicCategoryStructure();
