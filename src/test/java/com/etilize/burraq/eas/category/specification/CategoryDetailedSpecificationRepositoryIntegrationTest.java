...
import com.etilize.burraq.eas.category.specification.CategoryDetailedSpecification;
import com.etilize.burraq.eas.category.specification.CategoryDetailedSpecificationRepository;
...
/**
 * This class implements repository test cases for {@link CategoryDetailedSpecificationRepository}.
 *
 * @author Umar Zubair
 * @since 1.0
 */
...
public class CategoryDetailedSpecificationRepositoryIntegrationTest
    ...
    public void shouldFindDetailedCategoryStructuresByMultipleIds() {
        ...
        final Iterator<CategoryDetailedSpecification> categories = repository.findAllById(
                Lists.newArrayList(key1, key2)).iterator();
        assertThat(categories.hasNext(), is(true));
        CategoryDetailedSpecification category = categories.next();
    ...
    public void shouldFindDetailedCategoryStructuresById() {
        ...
        final Optional<CategoryDetailedSpecification> category = repository.findById(key);
    ...
    public void shouldCreateNewDetailedCategoryStructure() {
        final CategoryDetailedSpecification category = new CategoryDetailedSpecification();
