...
/**
 * This class implements repository test cases for {@link BasicMediaCategoryStructureRepository}.
 *
 * @author Umar Zubair
 * @since 1.0
 */
...
public class BasicMediaCategoryStructureRepositoryIntegrationTest
        extends AbstractIntegrationTest {

    @Autowired
    private BasicMediaCategoryStructureRepository repository;
    ...
    public void shouldFindBasicMediaCategoryStructuresByMultipleIds() {
        ...
        final Iterator<BasicMediaCategoryStructure> categories = repository.findAllById(
                Lists.newArrayList(key1, key2)).iterator();
        assertThat(categories.hasNext(), is(true));
        BasicMediaCategoryStructure category = categories.next();
    ...
    public void shouldFindBasicMediaCategoryStructuresById() {
        ...
        final Optional<BasicMediaCategoryStructure> category = repository.findById(key);
    ...
    public void shouldCreateNewBasicMediaCategoryStructure() {
        final BasicMediaCategoryStructure category = new BasicMediaCategoryStructure();
