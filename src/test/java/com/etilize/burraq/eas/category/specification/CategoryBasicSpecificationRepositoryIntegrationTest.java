...
import com.etilize.burraq.eas.category.specification.CategoryBasicSpecification;
import com.etilize.burraq.eas.category.specification.CategoryBasicSpecificationRepository;
...
/**
 * This class implements repository test cases for {@link CategoryBasicSpecificationRepository}.
 *
 * @author Umar Zubair
 * @since 1.0
 */
...
public class CategoryBasicSpecificationRepositoryIntegrationTest
    ...
    @Test
    public void shouldFindBasicCategoryStructuresByMultipleIds() {
        ...
        final Iterator<CategoryBasicSpecification> categories = repository.findAllById(
                Lists.newArrayList(key1, key2)).iterator();
        assertThat(categories.hasNext(), is(true));
        CategoryBasicSpecification category = categories.next();
    ...
    @Test
    public void shouldFindBasicCategoryStructuresById() {
        final CategorySpecificationKey key = new CategorySpecificationKey();
        key.setCategoryId("categoryId123");
        key.setLocaleId("en_CA");
        final Optional<CategoryBasicSpecification> category = repository.findById(key);
    ...
    @Test
    @ShouldMatchDataSet(location = "/datasets/basic_category_structures/basic_category_structures_after_create.bson")
    public void shouldCreateNewBasicCategoryStructure() {
        final CategoryBasicSpecification category = new CategoryBasicSpecification();
    ...
    @Test
    @ShouldMatchDataSet(location = "/datasets/basic_category_structures/basic_category_structures_after_update.bson")
    ...
    @Test
    @ShouldMatchDataSet(location = "/datasets/basic_category_structures/basic_category_structures_after_delete.bson")
    public void shouldDeleteBasicCategoryStructureById() {
        final CategorySpecificationKey key = new CategorySpecificationKey();
        key.setCategoryId("categoryId123");
        key.setLocaleId("en_CA");
