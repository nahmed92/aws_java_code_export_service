...
/**
 * This class implements repository test cases for {@link RichMediaCategoryStructureRepository}.
 *
 * @author Umar Zubair
 * @since 1.0
 */
...
public class RichMediaCategoryStructureRepositoryIntegrationTest
        extends AbstractIntegrationTest {

    @Autowired
    private RichMediaCategoryStructureRepository repository;
    ...
    public void shouldFindRichMediaCategoryStructuresByMultipleIds() {
        ...
        final Iterator<RichMediaCategoryStructure> categories = repository.findAllById(
                Lists.newArrayList(key1, key2)).iterator();
        assertThat(categories.hasNext(), is(true));
        RichMediaCategoryStructure category = categories.next();
    ...
    public void shouldFindRichMediaCategoryStructuresById() {
        ...
        final Optional<RichMediaCategoryStructure> category = repository.findById(key);
    ...
    public void shouldCreateNewRichMediaCategoryStructure() {
        final RichMediaCategoryStructure category = new RichMediaCategoryStructure();
