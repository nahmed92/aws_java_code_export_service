...
/**
 * This class implements repository test cases for {@link BarcodeService}.
 *
 * @author Umar Zubair
 * @since 1.0
 */
...
public class BarcodeServiceIntegrationTest extends AbstractIntegrationTest {
    ...
    @Override
    public void before() {
        service = new BarcodeServiceImpl(repository, specsStatusRepository);
