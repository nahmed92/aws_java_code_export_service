...
/**
 * POJO test for {@link ProductBarcode}
 *
 * @author Umar Zubair
 * @since 1.0
 */
public class ProductBarcodePojoTest {
    ...
    public void shouldValidateBarcodePOJO() {
        ...
        validator = ValidatorBuilder.create() //
                ...
                .build();
        validator.validate(PojoClassFactory.getPojoClass(ProductBarcode.class));
    }

    @Test
    public void shouldFollowEqualsContract() {
        EqualsVerifier.forClass(ProductBarcode.class) //
