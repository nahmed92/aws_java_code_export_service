...
/**
 * POJO test for {@link ProductBasicMediaSpecification}
 *
 * @author Umar Zubair
 * @since 1.0
 */
public class ProductBasicMediaSpecificationPojoTest {

    @Test
    public void shouldValidateBasicMediaSpecificationPOJO() {
    ...
    public void shouldFollowEqualsContract() {
        EqualsVerifier.forClass(ProductBasicMediaSpecification.class) //
