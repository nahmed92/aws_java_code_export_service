...
/**
 * POJO test for {@link BasicMediaSpecification}
 *
 * @author Umar Zubair
 * @since 1.0
 */
public class BasicMediaSpecificationPojoTest {
    ...
    public void shouldValidateBasicMediaSpecificationPOJO() {
        ...
        validator = ValidatorBuilder.create() //
                ...
                .build();
        validator.validate(PojoClassFactory.getPojoClass(BasicMediaSpecification.class));
    }

    @Test
    public void shouldFollowEqualsContract() {
        EqualsVerifier.forClass(BasicMediaSpecification.class) //
