...
/**
 * This class implements repository test cases for {@link RichMediaSpecificationRepository}.
 *
 * @author Umar Zubair
 * @since 1.0
 */
...
public class RichMediaSpecificationRepositoryIntegrationTest
        extends AbstractIntegrationTest {

    @Autowired
    private RichMediaSpecificationRepository repository;

    @Test
    public void shouldFindAllRichMediaSpecifications() {
        final List<RichMediaSpecification> specifications = Lists.newArrayList(
                repository.findAll());
    ...
    public void shouldFindRichMediaSpecificationById() {
        final Optional<RichMediaSpecification> specification = repository.findById(
                "product123-en");
