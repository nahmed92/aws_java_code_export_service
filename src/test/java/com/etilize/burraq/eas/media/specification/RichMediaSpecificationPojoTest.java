...
/**
 * POJO test for {@link RichMediaSpecification}
 *
 * @author Umar Zubair
 * @since 1.0
 */
public class RichMediaSpecificationPojoTest {
    ...
    public void shouldValidateRichMediaSpecificationPOJO() {
        ...
        validator = ValidatorBuilder.create() //
                ...
                .build();
        validator.validate(PojoClassFactory.getPojoClass(RichMediaSpecification.class));
    }

    @Test
    public void shouldFollowEqualsContract() {
        EqualsVerifier.forClass(RichMediaSpecification.class) //
