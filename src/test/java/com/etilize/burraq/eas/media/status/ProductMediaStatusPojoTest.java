...
/**
 * POJO test for {@link ProductMediaStatus}
 *
 * @author Umar Zubair
 * @since 1.0
 */
public class ProductMediaStatusPojoTest {

    @Test
    public void shouldValidateMediaStatusPOJO() {
        ...
        validator = ValidatorBuilder.create() //
                ...
                .build();
        validator.validate(PojoClassFactory.getPojoClass(ProductMediaStatus.class));
    }

    @Test
    public void shouldFollowEqualsContract() {
        EqualsVerifier.forClass(ProductMediaStatus.class) //
