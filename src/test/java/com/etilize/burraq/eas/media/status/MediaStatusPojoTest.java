...
/**
 * POJO test for {@link MediaStatus}
 *
 * @author Umar Zubair
 * @since 1.0
 */
public class MediaStatusPojoTest {
    ...
    public void shouldValidateMediaStatusPOJO() {
        ...
        validator = ValidatorBuilder.create() //
                ...
                .build();
        validator.validate(PojoClassFactory.getPojoClass(MediaStatus.class));
    }

    @Test
    public void shouldFollowEqualsContract() {
        EqualsVerifier.forClass(MediaStatus.class) //
