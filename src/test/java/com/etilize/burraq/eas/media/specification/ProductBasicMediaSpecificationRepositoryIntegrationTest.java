...
/**
 * This class implements repository test cases for {@link ProductBasicMediaSpecificationRepository}.
 *
 * @author Umar Zubair
 * @since 1.0
 */
...
public class ProductBasicMediaSpecificationRepositoryIntegrationTest
        extends AbstractIntegrationTest {

    @Autowired
    private ProductBasicMediaSpecificationRepository repository;

    @Test
    public void shouldFindAllBasicMediaSpecifications() {
        final List<ProductBasicMediaSpecification> specifications = Lists.newArrayList(
                repository.findAll());
    ...
    public void shouldFindBasicMediaSpecificationById() {
        final Optional<ProductBasicMediaSpecification> specification = repository.findById(
                "product123-en");
    ...
    public void shouldCreateNewBasicMediaSpecification() {
        ...
        final ProductBasicMediaSpecification specs = new ProductBasicMediaSpecification();
    ...
    public void shouldUpdateBasicMediaSpecification() {
        ...
        value.setWidth(160);
        value.setTags(Sets.newHashSet("Prod Specs"));
        final ProductBasicMediaSpecification specs = repository.findById(
