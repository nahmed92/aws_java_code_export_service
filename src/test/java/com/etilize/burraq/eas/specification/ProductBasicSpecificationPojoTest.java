...
/**
 * POJO test for {@link ProductBasicSpecification}
 *
 * @author Umar Zubair
 * @since 1.0
 */
public class ProductBasicSpecificationPojoTest {

    @Test
    public void shouldValidateBasicSpecificationPOJO() {
        ...
        validator = ValidatorBuilder.create() //
                ...
                .build();
        validator.validate(PojoClassFactory.getPojoClass(ProductBasicSpecification.class));
    }

    @Test
    public void shouldFollowEqualsContract() {
        EqualsVerifier.forClass(ProductBasicSpecification.class) //
