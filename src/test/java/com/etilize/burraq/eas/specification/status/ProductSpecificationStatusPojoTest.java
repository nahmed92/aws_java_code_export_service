...
/**
 * POJO test for {@link ProductSpecificationStatus}
 *
 * @author Umar Zubair
 * @since 1.0
 */
public class ProductSpecificationStatusPojoTest {
    ...
    public void shouldValidateSpecificationStatusPOJO() {
        ...
        validator = ValidatorBuilder.create() //
                ...
                .build();
        validator.validate(PojoClassFactory.getPojoClass(ProductSpecificationStatus.class));
    }

    @Test
    public void shouldFollowEqualsContract() {
        EqualsVerifier.forClass(ProductSpecificationStatus.class) //
