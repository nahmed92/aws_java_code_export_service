...
public class SpecificationServiceIntegrationTest extends AbstractIntegrationTest {
    ...
    @Mock
    private SpecificationStatusRepository specificationStatusRepository;

    @Autowired
    private BasicSpecificationRepository basicSpecificationRepository;

    @Autowired
    private DetailedSpecificationRepository detailedSpecificationRepository;

    @Override
    public void before() {
        service = new SpecificationServiceImpl(basicSpecificationRepository,
        ...
        final SpecificationStatus specsStatus3 = new SpecificationStatus();
