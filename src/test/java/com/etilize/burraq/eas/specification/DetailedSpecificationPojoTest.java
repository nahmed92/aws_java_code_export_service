...
/**
 * POJO test for {@link DetailedSpecification}
 *
 * @author Umar Zubair
 * @since 1.0
 */
public class DetailedSpecificationPojoTest {
    ...
    public void shouldValidateDetailedSpecificationPOJO() {
        ...
        validator = ValidatorBuilder.create() //
                ...
                .build();
        validator.validate(PojoClassFactory.getPojoClass(DetailedSpecification.class));
    }

    @Test
    public void shouldFollowEqualsContract() {
        EqualsVerifier.forClass(DetailedSpecification.class) //
