...
/**
 * This class implements repository test cases for {@link ProductSpecificationStatusRepository}.
 *
 * @author Umar Zubair
 * @since 1.0
 */
...
public class ProductSpecificationStatusRepositoryIntegrationTest
        extends AbstractIntegrationTest {

    @Autowired
    private ProductSpecificationStatusRepository repository;

    @Test
    public void shouldFindAllSpecificationStatuses() {
        final List<ProductSpecificationStatus> specifications = Lists.newArrayList(
                repository.findAll());
    ...
    public void shouldFindSpecificationStatusByProductId() {
        final List<ProductSpecificationStatus> specifications = repository.findAllByProductId(
                "product123");
        assertThat(specifications, hasSize(2));
        assertThat(specifications.get(0).getId(),
                isIn(Arrays.asList("product123-en", "product123-en_US")));
    ...
    public void shouldCreateNewSpecificationStatus() {
        final ProductSpecificationStatus specs = new ProductSpecificationStatus();
