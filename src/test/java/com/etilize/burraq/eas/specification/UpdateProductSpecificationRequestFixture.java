...
/**
 * Test fixture for {@link UpdateProductSpecificationRequest}
 *
 * @author Nasir Ahmed
 * @since 1.0
 *
 */
public class UpdateProductSpecificationRequestFixture {

    public static UpdateProductSpecificationRequest createWithUpdatedAttributes() {
    ...
    public static UpdateProductSpecificationRequest createWithAddedAttributeValue() {
        final UpdateProductSpecificationRequest request = new UpdateProductSpecificationRequest(
                "product123", "en");
    ...
    public static UpdateProductSpecificationRequest createWithRemovedAttributeValue() {
        final UpdateProductSpecificationRequest request = new UpdateProductSpecificationRequest(
                "product123", "en");
    ...
    public static UpdateProductSpecificationRequest createWithRemovedAttributeIds() {
        final UpdateProductSpecificationRequest request = new UpdateProductSpecificationRequest(
                "product123", "en");
    ...
    public static UpdateProductSpecificationRequest createWithMiscUpdates() {
        final UpdateProductSpecificationRequest request = new UpdateProductSpecificationRequest(
                "product123", "en");
        request.addUpdatedAttributes("mfgId", new Value("Acer"));
