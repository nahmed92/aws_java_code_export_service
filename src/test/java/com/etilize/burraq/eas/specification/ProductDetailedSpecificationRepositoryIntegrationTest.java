...
/**
 * This class implements repository test cases for {@link ProductDetailedSpecificationRepository}.
 *
 * @author Umar Zubair
 * @since 1.0
 */
...
public class ProductDetailedSpecificationRepositoryIntegrationTest
        extends AbstractIntegrationTest {

    @Autowired
    private ProductDetailedSpecificationRepository repository;
    ...
    public void shouldFindAllDetailedSpecifications() {
        final List<ProductDetailedSpecification> specifications = Lists.newArrayList(
                repository.findAll());
    ...
    public void shouldCreateNewDetailedSpecification() {
        final ProductDetailedSpecification specs = new ProductDetailedSpecification();
