...
/**
 * POJO test for {@link ProductDetailedSpecification}
 *
 * @author Umar Zubair
 * @since 1.0
 */
public class ProductDetailedSpecificationPojoTest {

    @Test
    public void shouldValidateDetailedSpecificationPOJO() {
    ...
    public void shouldFollowEqualsContract() {
        EqualsVerifier.forClass(ProductDetailedSpecification.class) //
