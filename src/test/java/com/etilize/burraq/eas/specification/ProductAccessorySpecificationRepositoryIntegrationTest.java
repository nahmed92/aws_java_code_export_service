...
/**
 * This class implements repository test cases for {@link ProductAccessorySpecificationRepository}.
 *
 * @author Kaiser Raja
 * @since 1.0
 */
...
public class ProductAccessorySpecificationRepositoryIntegrationTest
    ...
    @ShouldMatchDataSet(location = "/datasets/accessory_specifications/accessory_specifications_with_attributes_after_update_attributes.bson")
    ...
    @Test
    @UsingDataSet(locations = "/datasets/accessory_specifications/accessory_specifications_with_attributes.bson", loadStrategy = LoadStrategyEnum.CLEAN_INSERT)
    @ShouldMatchDataSet(location = "/datasets/accessory_specifications/accessory_specifications_with_attributes_after_add_in_set.bson")
    @IgnorePropertyValue(properties = { "lastUpdateDate" })
    ...
    @Test
    @UsingDataSet(locations = "/datasets/accessory_specifications/accessory_specifications_with_attributes.bson", loadStrategy = LoadStrategyEnum.CLEAN_INSERT)
    @ShouldMatchDataSet(location = "/datasets/accessory_specifications/accessory_specifications_with_attributes_after_remove_in_set.bson")
    @IgnorePropertyValue(properties = { "lastUpdateDate" })
    ...
    @Test
    @UsingDataSet(locations = "/datasets/accessory_specifications/accessory_specifications_with_attributes.bson", loadStrategy = LoadStrategyEnum.CLEAN_INSERT)
    @ShouldMatchDataSet(location = "/datasets/accessory_specifications/accessory_specifications_with_attributes_after_remove_attribute.bson")
    @IgnorePropertyValue(properties = { "lastUpdateDate" })
    ...
    @Test
    @UsingDataSet(locations = "/datasets/accessory_specifications/accessory_specifications_with_attributes.bson", loadStrategy = LoadStrategyEnum.CLEAN_INSERT)
    @ShouldMatchDataSet(location = "/datasets/accessory_specifications/accessory_specifications_with_attributes_after_update_misc.bson")
    @IgnorePropertyValue(properties = { "lastUpdateDate" })
    ...
    @Test
    public void shouldFindAllAccessorySpecifications() {
        final List<ProductAccessorySpecification> specifications = Lists.newArrayList(
                repository.findAll());
    ...
    @Test
    @ShouldMatchDataSet(location = "/datasets/accessory_specifications/accessory_specifications_after_create.bson")
    ...
    @Test
    @ShouldMatchDataSet(location = "/datasets/accessory_specifications/accessory_specifications_after_delete.bson")
