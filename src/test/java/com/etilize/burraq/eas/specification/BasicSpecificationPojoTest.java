...
/**
 * POJO test for {@link BasicSpecification}
 *
 * @author Umar Zubair
 * @since 1.0
 */
public class BasicSpecificationPojoTest {
    ...
    public void shouldValidateBasicSpecificationPOJO() {
        ...
        validator = ValidatorBuilder.create() //
                ...
                .build();
        validator.validate(PojoClassFactory.getPojoClass(BasicSpecification.class));
    }

    @Test
    public void shouldFollowEqualsContract() {
        EqualsVerifier.forClass(BasicSpecification.class) //
