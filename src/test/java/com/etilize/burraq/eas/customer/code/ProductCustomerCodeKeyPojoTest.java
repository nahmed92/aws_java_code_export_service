...
/**
 * POJO test for {@link ProductCustomerCodeKey}
 *
 * @author Umar Zubair
 * @since 1.0
 */
public class ProductCustomerCodeKeyPojoTest {
    ...
    public void shouldValidateCustomerCodeKeyPOJO() {
        ...
        validator = ValidatorBuilder.create() //
                ...
                .build();
        validator.validate(PojoClassFactory.getPojoClass(ProductCustomerCodeKey.class));
    }

    @Test
    public void shouldFollowEqualsContract() {
        EqualsVerifier.forClass(ProductCustomerCodeKey.class) //
    ...
    public void shouldContainToString() throws ParseException {
        final ProductCustomerCodeKey customerCodeKey = new ProductCustomerCodeKey();
