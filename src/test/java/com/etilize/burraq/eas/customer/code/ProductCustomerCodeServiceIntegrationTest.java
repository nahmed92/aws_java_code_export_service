...
/**
 * This class implements repository test cases for {@link ProductCustomerCodeService}.
 *
 * @author Umar Zubair
 * @since 1.0
 */
...
public class ProductCustomerCodeServiceIntegrationTest extends AbstractIntegrationTest {

    @Mock
    private LocaleService localeService;

    private ProductCustomerCodeService service;
    ...
    @Override
    public void before() {
        service = new ProductCustomerCodeServiceImpl(repository, localeService);
