...
import com.etilize.burraq.eas.accessory.ProductAccessoryRepository;
import com.etilize.burraq.eas.accessory.ProductAccessoryService;
import com.etilize.burraq.eas.accessory.ProductAccessoryServiceImpl;
...
/**
 * This class implements repository test cases for {@link ProductAccessoryService}.
 *
 * @author Umar Zubair
 * @since 1.0
 */
...
public class ProductAccessoryServiceIntegrationTest extends AbstractIntegrationTest {

    @Mock
    private LocaleService localeService;

    private ProductAccessoryService service;

    @Autowired
    private ProductAccessoryRepository repository;

    @Override
    public void before() {
        service = new ProductAccessoryServiceImpl(repository, localeService);
