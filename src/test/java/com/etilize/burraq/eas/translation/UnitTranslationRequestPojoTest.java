...
/**
 * This class represents POJO test cases for {@link UnitTranslationRequest}.
 *
 * @author Umar Zubair
 */
public class UnitTranslationRequestPojoTest {

    @Test
    public void validateUnitTranslationRequestPojo() {
        ...
        validator = ValidatorBuilder.create() //
                ...
                .build();
        validator.validate(PojoClassFactory.getPojoClass(UnitTranslationRequest.class));
    }

    @Test
    public void shouldFollowEqualsContract() {
        EqualsVerifier.forClass(UnitTranslationRequest.class) //
                .verify();
    }
