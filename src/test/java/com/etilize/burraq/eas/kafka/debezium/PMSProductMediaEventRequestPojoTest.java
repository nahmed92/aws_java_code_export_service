...
/**
 * POJO test for {@link PMSProductMediaEventRequest}
 *
 * @author Affan Hasan
 * @since 1.0
 */
public class PMSProductMediaEventRequestPojoTest {
    ...
    public void shouldValidateSpecificationPOJO() {
        ...
        validator = ValidatorBuilder.create() //
                ...
                .build();
        validator.validate(
                PojoClassFactory.getPojoClass(PMSProductMediaEventRequest.class));
    }

    @Test
    public void shouldFollowEqualsContract() {
        EqualsVerifier.forClass(PMSProductMediaEventRequest.class) //
                .verify();
    }
